...
| `spacingSm` | `tokens.bpk-spacing-sm()` | 0.25rem (4px) | Tight: icon-to-text, badge padding |
| `spacingMd` | `tokens.bpk-spacing-md()` | 0.5rem (8px) | Compact: between related items |
| `spacingIconText` | `tokens.$bpk-spacing-icon-text` | 0.5rem (8px) | Gap between icon and text |
